...
class MainWindow(Frame):
    ...
    def clickRecordButton(self):
        ...
        tenSecondsButton = Button(recordWindow, width=150, height=140, text='10 s', font=('Helvetica bold', 72), fg='green', command=lambda : self.recordAudio(10))
        tenSecondsButton.place(x=10, y=10)
        twentySecondsButton = Button(recordWindow, width=150, height=140, text='20 s', font=('Helvetica bold', 72), fg='green', command=lambda : self.recordAudio(20))
        twentySecondsButton.place(x=10, y=160)
        thirtySecondsButton = Button(recordWindow, width=150, height=140, text='30 s', font=('Helvetica bold', 72), fg='green', command=lambda : self.recordAudio(30))
        thirtySecondsButton.place(x=180, y=10)
        oneMinuteButton = Button(recordWindow, width=150, height=140, text='1 min', font=('Helvetica bold', 72), fg='green', command=lambda : self.recordAudio(60))
        oneMinuteButton.place(x=180, y=160)
        threeMinutesButton = Button(recordWindow, width=150, height=140, text='3 min', font=('Helvetica bold', 72), fg='green', command=lambda : self.recordAudio(180))
